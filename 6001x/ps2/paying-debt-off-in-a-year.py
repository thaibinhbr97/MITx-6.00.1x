...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  9 14:15:20 2022
...
#     for i in range(12):   
#         remainingBalance = currentBalance - minMonthlyPayment
#         interest = monthlyInterestRate*remainingBalance
#         currentBalance = remainingBalance+interest
#     if currentBalance <= 0:
#         break
...
monthlyInterestRate = annualInterestRate/12.0
lower = currentBalance/12
upper = (currentBalance*(1+monthlyInterestRate)**12)/12.0
mid = (lower+upper)/2
epsilon = 0.01
...
while True:
    ...
    currentBalance = balance
    for i in range(12):   
        remainingBalance = currentBalance - mid
        interest = monthlyInterestRate*remainingBalance
        currentBalance = remainingBalance+interest
    if currentBalance < 0:
        upper = mid
