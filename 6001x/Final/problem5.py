...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 27 23:09:51 2022
...
# In this problem, you will implement a class according to the specifications in 
# the template file usresident.py. The file contains a Person class similar to 
# what you have seen in lecture and a USResident class (a subclass of Person). 
...
class USResident(Person):
    ...
    def __init__(self, name, status):
        ...
        options = ["citizen", "legal_resident", "illegal_resident"]
