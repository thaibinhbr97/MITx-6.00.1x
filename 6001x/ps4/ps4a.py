    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"{}" earned {} points. Total: {} points'.format(user_input,getWordScore(user_input, n),total_score))
                print()
                # Update the hand 
...
def playGame(wordList):
    ...
    """
    while True:
        user_command = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")          
        if user_command == 'n':
